...
<body class="index-page">
  ...
  <header id="header" class="header d-flex align-items-center sticky-top" style="background-color: #74b7ed;">
  <!-- <header id="header" class="header d-flex align-items-center sticky-top style="background-color: lime;> -->
