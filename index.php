...
?>
  ...
  <main class="main">
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link"> Sound and Light System Rental</a></h4>
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Event Planning</a></h4>
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="300">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Live Band</a></h4>
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="fade-up" data-aos-delay="400">
            <div class="service-item position-relative">
              ...
              <h4><a href="" class="stretched-link">Corporate Services</a></h4>
      ...
      <div class="container">
        ...
        <div class="row gy-5">
          ...
          <div class="content col-xl-5 d-flex flex-column" data-aos="fade-up" data-aos-delay="100">
            <h3>Who are we?</h3>
            <p>
            OBY Entertainment is a leading full-service entertainment brand, offering magical lifetime memories through creative management. Positioned at the heart of events and entertainment, we're growing into a trusted partner. We craft impactful, innovative experiences for brands with insightful strategies and modern tech.
            </p>
          ...
          <div class="col-xl-7" data-aos="fade-up" data-aos-delay="200">
            <div class="row gy-4">
              ...
              <div class="col-md-6 icon-box position-relative">
                ...
                <h4><a href="" class="stretched-link">Cooperate Services</a></h4>
                <p>Consequuntur sunt aut quasi enim aliquam quae harum pariatur laboris nisi ut aliquip</p>
              </div><!-- Icon-Box -->

              <div class="col-md-6 icon-box position-relative">
                <i class="bi bi-gem"></i>
                <h4><a href="" class="stretched-link">Road Shows</a></h4>
                <p>Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt</p>
              </div><!-- Icon-Box -->

              <div class="col-md-6 icon-box position-relative">
                <i class="bi bi-broadcast"></i>
                <h4><a href="" class="stretched-link">Live Bands</a></h4>
                <p>Aut suscipit aut cum nemo deleniti aut omnis. Doloribus ut maiores omnis facere</p>
              </div><!-- Icon-Box -->

              <div class="col-md-6 icon-box position-relative">
                <i class="bi bi-easel"></i>
                <h4><a href="" class="stretched-link">Parties</a></h4>
              ...
              <div class="col-lg-6">
                <div class="stats-item d-flex">
                  ...
                  <div>
                    ...
                    <p><strong>Happy Clients</strong> <span>Served</span></p>
                  </div>
                </div>
              </div><!-- End Stats Item -->
              ...
              <div class="col-lg-6">
                <div class="stats-item d-flex">
                  ...
                  <div>
                    ...
                    <p><strong>Years</strong> <span>of Services</span></p>
                  </div>
                </div>
              </div><!-- End Stats Item -->
    ...
    <section id="team" class="team section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Team</h2>
        <p>Our team comprise of vibrant and dedicated professionals delivering your memorable moments.</p>
      </div><!-- End Section Title -->
    ...
    <section id="pricing" class="pricing section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Pricing</h2>
        <p>We have a pocket friendly prices suiting your needs</p>
      </div><!-- End Section Title -->
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="pricing-item">
              <h3>Live Bands</h3>
              <h4><sup>Ksh</sup>5000<span> / Hour</span></h4>
              <ul>
          ...
          <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="pricing-item featured">
              <h3>Night Events</h3>
              <h4><sup>Ksh</sup>5500<span> / Hour</span></h4>
              <ul>
                <li><i class="bi bi-check"></i> <span>Quam adipiscing vitae proin</span></li>
                <li><i class="bi bi-check"></i> <span>Nec feugiat nisl pretium</span></li>
                <li><i class="bi bi-check"></i> <span>Nulla at volutpat diam uteera</span></li>
          ...
          <div class="col-lg-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="pricing-item">
              <h3>Corporate Services</h3>
              <h4><sup>Ksh</sup>10,000<span> / Hour</span></h4>
              <ul>
                <li><i class="bi bi-check"></i> <span>Quam adipiscing vitae proin</span></li>
                <li><i class="bi bi-check"></i> <span>Nec feugiat nisl pretium</span></li>
                <li><i class="bi bi-check"></i> <span>Nulla at volutpat diam uteera</span></li>
